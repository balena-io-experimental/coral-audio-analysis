# Based on https://github.com/balena-io-examples/google-coral-dev-sample
...
# Get some audio recording tools and their dependencies
RUN \
    apt-get install -y python3-pyaudio libsdl-image1.2-dev libsdl-mixer1.2-dev libsdl-ttf2.0-dev \
    libsdl1.2-dev libsmpeg-dev python-numpy subversion libportmidi-dev ffmpeg libswscale-dev \
    libavformat-dev libavcodec-dev libfreetype6-dev alsa-tools alsa-utils
